...
/**
 * Resolve the semantic view FQN.
 * - SPCS: env SEMANTIC_VIEW, else the app config table (bundled APP_DATA view).
...
async function getSemanticView(): Promise<string> {
  ...
  cachedSemanticView = "SAP_SALES_360.SEMANTIC.SAP_SALES_360_ANALYTICS";
  return cachedSemanticView;
}
