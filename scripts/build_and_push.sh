#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# Build the Sales 360 container image and push it to a Snowflake image
...
#
# The image is pushed to:  <registry_host>/<repo_path>/sales_360:latest
...
IMAGE="${REGISTRY_HOST}/${REPO_PATH}/sales_360:latest"
