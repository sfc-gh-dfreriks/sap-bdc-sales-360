#!/usr/bin/env python3
"""
Deploy the Sales 360 Native App into one account (run once per region).
...
Steps performed:
  1. Upload the 4 app artifacts (manifest, setup.sql, service_spec, README)
     to SALES_360_PKG.PUBLIC.APP_STAGE
  ...
  4. CREATE APPLICATION SALES_360_APP + grant account privileges
